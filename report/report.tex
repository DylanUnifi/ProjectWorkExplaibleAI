...
However, post-hoc methods have been criticized for their lack of fidelity and potential to generate misleading explanations. As an alternative, intrinsically interpretable models like the Prototypical Part Network (ProtoPNet) \cite{chen2019this} incorporate interpretability directly into the architecture by dissecting images into prototypes.
...
\begin{itemize}
    \item \textbf{CLE4EVR}: A dataset composed of 3D objects (spheres, cubes, cylinders) rendered with diverse colors and materials. It tests the models' ability to localize large, well-defined objects in a 3D scene.
...
To ensure a fair and rigorous comparison, we implemented a custom XAI metric suite:
\begin{itemize}
